...
// Fallback weather when outside forecast range
const FALLBACK_WEATHER = [
  { emoji: "☀️", temp: "24°C", desc: "舒適 · 初夏好天氣", rainPercent: 10, outfitTip: "👕 短袖 + 薄外套，室內外冷熱差大，隨時可穿脫" },
  { emoji: "🌤️", temp: "20°C", desc: "海邊涼爽，海風強勁", rainPercent: 25, outfitTip: "🧥 洋蔥式穿搭 + 防風外套，帽子必備" },
  { emoji: "🌡️", temp: "29°C", desc: "京都盆地悶熱，紫外線強", rainPercent: 15, outfitTip: "🕶️ 排汗透氣夏裝 + 防曬乳 + 遮陽帽" },
  { emoji: "⛅", temp: "26°C", desc: "大阪港灣海風清涼", rainPercent: 20, outfitTip: "👕 透氣短袖，遊船時套上防風薄外套" },
  { emoji: "🌦️", temp: "25°C", desc: "留意短暫陣雨", rainPercent: 40, outfitTip: "👟 寬鬆舒適機場裝，帶輕便晴雨傘" },
]
...
const SCHEDULE = [
  ...
  },
  {
    ...
    events: [
      ...
      { id: "d2e6", time: "14:30", title: "🕊️ 伊根舟屋 & 餵海鷗", category: "sight" as EventCategory, notes: "拿蝦味先餵食海鷗與老鷹，小朋友最期待！", mapUrl: "https://maps.google.com/?q=Ine+Funaya+Kyoto" },
  ...
  },
  {
    ...
    events: [
      ...
      { id: "d3e3", time: "09:30", title: "⛩ 伏見稻荷大社 千本鳥居", category: "sight" as EventCategory, notes: "往上走15分鐘到奧社奉拜所，人潮銳減、光影絕美！", mapUrl: "https://maps.google.com/?q=Fushimi+Inari+Taisha+Kyoto" },
  ...
  },
  {
    ...
    events: [
      ...
      { id: "d4e2", time: "09:00", title: "🏯 大阪城公園", category: "sight" as EventCategory, notes: "周遊卡免費！A組：小火車+御座船 / B組：自由漫步", mapUrl: "https://maps.google.com/?q=Osaka+Castle+Park" },
      ...
      { id: "d4e6", time: "16:15", title: "通天閣 & 新世界懷舊", category: "sight" as EventCategory, notes: "周遊卡免費入場（原價 ¥1,000）", mapUrl: "https://maps.google.com/?q=Tsutenkaku+Shinsekai+Osaka" },
...
export default function SchedulePage() {
  ...
  // Use live weather if available, otherwise fallback
  const wx = weatherMap[day.date] ?? FALLBACK_WEATHER[activeDayIndex]
  ...
  return (
    <div className="p-4 pb-6">
      ...
      <div className="bg-card border-2 border-border rounded-2xl p-3 mb-4 shadow-card">
        {loading ? (
          <div className="text-xs text-muted text-center py-2">天氣載入中...</div>
        ) : (
          <>
            <div className="flex items-center gap-3">
              <span className="text-4xl">{wx.emoji}</span>
              <div>
                <div className="text-2xl font-bold text-accent-2 leading-none">{wx.temp}</div>
                <div className="text-xs text-muted mt-0.5">{wx.desc}</div>
              </div>
              <div className="ml-auto text-right">
                <div className="text-[10px] text-muted">降雨率</div>
                <div className="text-xl font-bold text-accent-3">{wx.rainPercent}%</div>
              </div>
            </div>
